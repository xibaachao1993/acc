...
<div id="wrap">
    ...
    <div class="menu fleft">
    	<ul>
        	<li class="subMenuTitle">常用功能</li>
            <li class="subMenu"><a href="#">网站全局</a>
            	<ul style="display:none">
                	<li><a href="Webset" target="right">网站设置</a></li>
                    <li><a href="Webset/getmes" target="right">查看留言</a></li>
                    <li><a href="Webset/getlink" target="right">友情链接</a></li>
                </ul>
            </li>
           
            <li class="subMenu"><a href="#">栏目管理</a>
            	<ul style=" display:none">
                	<li><a href="Column" target="right">添加栏目</a></li>
                    <li><a href="Column/getcol" target="right">管理栏目</a></li>
                </ul>
            </li>
            
            <li class="subMenu"><a href="#">文章管理</a>
            	<ul style="display:none">
                	<li><a href="Article" target="right">发布文章</a></li>
                    <li><a href="Article/getarticle" target="right">管理文章</a></li>
                </ul>
            </li>           
        </ul>
    </div>
    ...
    <div class="clear"></div>
    <div id="footer">CopyRight &copy; 2012-2014 www.blueidea.com </div><!--#footer -->
